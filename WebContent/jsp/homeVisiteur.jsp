			...
			<div class="row g-5 align-items-center">
				<div class="col-lg-6">
					...
					<div class="animated slideInDown">
						<h1 class="display-4 mb-3">YourHome</h1>
						<h2 class=" ville animated slideInDown">Votre agence
							immobilière à Aubervilliers</h2>
						...
						<nav aria-label="breadcrumb animated slideInDown">
							<div class="breadcrumb mb-0 ">
								...
								<li class="breadcrumb-item active" aria-current="page"><br>
									Sur notre site, vous aurez la possibilité de consulter une
									multitude d’annonces immobilières qui saura répondre à vos
									besoins. <br>Maison, appartement, studio : un large choix
									vous est proposé. <br>Nos agents sont à votre
									disponibilité pour vous accompagner dans vos projets
									immobiliers en fonction de vos critères. <br> <br>
									Retrouvez-nous au : 72 Rue du Moutier - 93300 AUBERVILLIERS
									</li>
							</div>
						</nav>
					</div>
				...
				<div class="col-lg-6 animated fadeIn">
					<img class="img-fluid animated pulse infinite"
						...
						src="https://www.journaldelagence.com/wp-content/uploads/2021/12/PRIX-IMMOBILIER--1024x643.jpeg"
						alt="">
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row g-5 align-items-center">
				...
				<header class="text-center mb-5">
					<h1 class="font-weight-bold">Retrouvez les dernières annonces
						mises en ligne</h1>
					<p class="font-italic text-muted mb-0">Offre(s) mise(s) en
						ligne il y a moins de 7 jours</p>
				...
				<form id="carouselOffres" name="carouselOffres">
					<div class="col-12" style="margin-left: 250px;"
						...
						<button type="submit" class="btn btn-primary"
							onclick="getAllOffres()">Toutes les offres</button>
					</div>
				</form>

				<div class="container-fluid">
					<div class="insurance-content">
						<div class="owl-carousel owl-loaded" id="offre-carousel"></div>
